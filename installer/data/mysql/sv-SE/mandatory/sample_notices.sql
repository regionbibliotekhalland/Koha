...
VALUES ('circulation','ODUE','Övertidsbrev','Försenade lån','Hej <<borrowers.firstname>> <<borrowers.surname>>,\n\nDu har när detta brev skickas försenade lån. Ditt bibliotek tar inte ut övertidsavgifter men vänliga återlämna eller låna om dem på nedanstående bibliotek så fort som möjligt.\n\n<<branches.branchname>>\n<<branches.branchaddress1>>\n<<branches.branchaddress2>> <<branches.branchaddress3>>\nTel: <<branches.branchphone>>\nFax: <<branches.branchfax>>\nEpost: <<branches.branchemail>>\n\nOm du har registrerat ett lösenord kan du själv låna om via dina kontosidor i bibliotekskatalogen. Om ett lån blir mer än 30 dagar försenat spärras ditt bibliotekskort tills lånet är återlämnat.\n\nFöljande lån är för närvarande försenade:\n\n<item>"<<biblio.title>>" av <<biblio.author>>, <<items.itemcallnumber>>, Streckkod: <<items.barcode>> Avgift: <<items.fine>></item>\n\nVänliga hälsningar personalen på <<branches.branchname>>\n', 'email'),
...
('circulation','DUE','Återlämningsbegäran','Återlämningsbegäran','Hej <<borrowers.firstname>> <<borrowers.surname>>,\r\n\r\nFöljande lån skall lämnas tillbaka idag:\r\n\r\n<<biblio.title>>, <<biblio.author>> (<<items.barcode>>)', 'email'),
